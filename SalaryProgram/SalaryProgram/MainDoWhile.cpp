...
Description: This program uses a Do-While Loop to calculcate a salary that compounds daily by 1 cent. User provides Number of days.
*/
...
int MainDoWhile()
{
	...
	cout << "Author: Michael Zuccarino" << endl << "Description: This program uses a Do - While Loop to calculcate a salary that compounds daily by 1 cent. User provides Number of days." << endl;
